def avg_mass(input_file,out_name):
    ...
    for line in f:
      ...
      if len(line_cleaned) == 14:
        ...
        if line_cleaned[0] == '-1000':
          total_mass.append(sum(time_masses)/len(time_masses))
          total_mass_pop1.append(sum(time_masses_pop1)/len(time_masses_pop1))

          if has_pop2:
            total_mass_pop2.append(sum(time_masses_pop2)/len(time_masses_pop2))
            time_masses_pop2 = []
    ...
    for line in f:
      ...
      if len(line_cleaned) == 14: 
        ...
        if line_cleaned[0] == '-1000':
          ...
          if has_pop2:
            total_mass_pop2.append(len(time_masses_pop2))
            time_masses_pop2 = []
...
def plot_num(input_file,output_type):
...
def plot_avgmass(input_file,output_type):
  import matplotlib.pyplot as plt
  from math import ceil
  from sys import argv
